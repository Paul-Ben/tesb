    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row w-100 mx-1">
            <div class="col-lg-12 mx-auto">
                <div class="bg-light rounded h-100 p-4">
                    <h4>Payment Form</h4>
                    <form action="{{route('admin.manualPayment.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <!-- Left Column -->
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="amount" id="term" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{ $guardian->guardian_name }}" class="form-control" readonly required>
                                </div>
                                <div class="form-group">
                                    <label for="lga">Pay Item </label>
                                    <input type="text" name="payitem" id="term" placeholder="eg. School Fees" class="form-control" required>
                                </div>
                                <div class="form-group">
