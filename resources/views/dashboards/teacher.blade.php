            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        ...
                        <img class="rounded-circle" src="{{ optional(optional($authUser)->teacher)->image ? asset('storage/' . $authUser->teacher->image) : asset('uploads/avatars/default-avatar.jpg') }}" alt="Profile image" style="width: 40px; height: 40px;">
