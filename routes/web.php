...
Route::get('/results', [FrontendController::class, 'resultSearch'])->name('frontresult.search');
Route::post('/results/check', [FrontendController::class, 'checkResult'])->name('frontresult.check');
