                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xl-12 mb-3">
                            ...
                            <div class="image-container" onclick="document.getElementById('fileInput').click();">
                                {{-- <img id="profileImage" src="{{ asset('uploads/avatars/'. $authUser ?? 'default-avatar.jpg')  }}" alt="Profile Photo"> --}}
                        ...
                        <div class="col-sm-12 col-xl-4 mb-3">
                            ...
                            <input type="text" name="first_name" value="{{ $authUser->teacher->first_name }}" class="form-control">
                        </div>
                        <div class="col-sm-12 col-xl-4 mb-3">
                            <label for="exampleInputEmail1" class="form-label">Middle Name</label>
                            <input type="text" name="middle_name" value="{{ $authUser->teacher->middle_name }}" class="form-control">
                        </div>
                        <div class="col-sm-12 col-xl-4 mb-3">
                            <label for="exampleInputEmail1" class="form-label">Last Name</label>
                            <input type="text" name="last_name" value="{{ $authUser->teacher->last_name }}" class="form-control">
                        </div>
                        <div class="col-sm-12 col-xl-4 mb-3">
                            <label for="exampleInputEmail1" class="form-label">Email</label>
                            <input type="text" name="email" value="{{ $authUser->teacher->email }}" class="form-control">
                        </div>
                        <div class="col-sm-12 col-xl-4 mb-3">
                            <label for="exampleInputEmail1" class="form-label">Date of Birth</label>
                            <input type="text" name="date_of_birth" value="{{ $authUser->teacher->date_of_birth }}" class="form-control">
                        </div>
                        <div class="col-sm-12 col-xl-4 mb-3">
                            <label for="exampleInputEmail1" class="form-label">Phone Number</label>
                            <input type="text" name="phone_number" value="{{ $authUser->teacher->phone_number }}" class="form-control">
                        </div>
                        <div class="col-sm-12 col-xl-6 mb-3">
                            <label for="exampleInputEmail1" class="form-label">Qualification</label>
                            <input type="text" name="qualification" value="{{ $authUser->teacher->qualification }}" class="form-control">
                        </div>
                        <div class="col-sm-12 col-xl-6 mb-3">
                            <label for="exampleInputEmail1" class="form-label">Address</label>
                            <input type="text" name="address" value="{{ $authUser->teacher->address }}" class="form-control">
                        </div>
