            ...
            <div class="report-card container w-4/5 max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 mt-5">
                ...
                <section class="attendance mb-4">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td class="border p-2"><input type="number" name="school_opened" class="form-control"></td>
                                <td class="border p-2"><input type="number" name="times_present" class="form-control"></td>
                                <td class="border p-2"><input type="number" name="times_absent" class="form-control"></td>
                            </tr>
                        </tbody>
                    </table>
                </section>
